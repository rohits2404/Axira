...
const statusIconMap: Record<TaskStatus, React.ReactNode> = {
    [TaskStatus.BACKLOG]: <CircleDashed className="size-4.5 text-pink-400" />,
    [TaskStatus.TODO]: <Circle className="size-4.5 text-red-400" />,
    [TaskStatus.IN_PROGRESS]: <CircleDotDashed className="size-4.5 text-yellow-400" />,
    [TaskStatus.IN_REVIEW]: <CircleDot className="size-4.5 text-blue-400" />,
    [TaskStatus.DONE]: <CircleCheck className="size-4.5 text-emerald-400" />,
};
